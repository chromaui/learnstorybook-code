...
This repository holds the main Angular and Storybook configuration files for the Intro to Storybook tutorial.
...
1.  **Browse your stories!**
    ...
    Run `ng run taskbox:storybook` to see your component's stories at `http://localhost:6006`
...
8.  **`jest.config.js`**: This file tells contains the setup for [Jest](https://jestjs.io/).
